...
echo ""
echo "Next steps:"
echo "  1. Set your LLM credentials — open the settings file with:"
echo "       nano $INSTALL_DIR/.env"
echo "     (or on macOS: open -e $INSTALL_DIR/.env)"
echo "  2. Restart Cursor / Claude, then ask it: run qa_setup_check"
echo ""
